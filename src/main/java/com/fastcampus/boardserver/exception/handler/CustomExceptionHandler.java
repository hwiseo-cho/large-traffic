...
import com.fastcampus.boardserver.exception.BoerdServerException;
...
public class CustomExceptionHandler {
    ...
    @ExceptionHandler({BoerdServerException.class})
    public ResponseEntity<Object> handlerBoerdServerException(BoerdServerException e) {
        CommonResponse commonResponse = new CommonResponse(HttpStatus.OK, "BoerdServerException", e.getMessage(), e.getMessage());
        return new ResponseEntity<>(commonResponse, new HttpHeaders(), commonResponse.getStatus());
    }
